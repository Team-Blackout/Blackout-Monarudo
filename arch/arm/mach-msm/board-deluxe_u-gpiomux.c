...
struct msm_gpiomux_config deluxe_u_ethernet_configs[] = {
};
#endif
...
#endif
static struct msm_gpiomux_config deluxe_u_hsic_configs[] = {
	{
		.gpio = 88,               
		.settings = {
...
static struct msm_gpiomux_config deluxe_u_gsbi_configs[] __initdata = {
	{
		.gpio      = 21,		
		.settings = {
...
static struct msm_gpiomux_config deluxe_u_slimbus_config[] __initdata = {
	{
		.gpio   = 40,           
		.settings = {
...
static struct msm_gpiomux_config deluxe_u_audio_codec_configs[] __initdata = {
	{
		.gpio = 39,
		.settings = {
...
#if 0
static struct msm_gpiomux_config deluxe_u_ext_regulator_configs[] __initdata = {
	{
		.gpio = deluxe_u_EXT_3P3V_REG_EN_GPIO,
		.settings = {
...
struct msm_gpiomux_config deluxe_u_rotate_key_config[] = {
	{
		.gpio = 46,
		.settings = {
...
#if 0
static struct msm_gpiomux_config deluxe_u_mxt_configs[] __initdata = {
	{	
		.gpio = 6,
		.settings = {
...
#endif
void __init deluxe_u_init_gpiomux(void)
{
	int rc;
...
#if defined(CONFIG_KS8851) || defined(CONFIG_KS8851_MODULE)
	msm_gpiomux_install(deluxe_u_ethernet_configs,
			ARRAY_SIZE(deluxe_u_ethernet_configs));
#endif
#if 0
	msm_gpiomux_install(wcnss_5wire_interface,
			ARRAY_SIZE(wcnss_5wire_interface));
#endif
	msm_gpiomux_install(deluxe_u_gsbi_configs,
			ARRAY_SIZE(deluxe_u_gsbi_configs));

	msm_gpiomux_install(deluxe_u_slimbus_config,
			ARRAY_SIZE(deluxe_u_slimbus_config));

	msm_gpiomux_install(deluxe_u_audio_codec_configs,
			ARRAY_SIZE(deluxe_u_audio_codec_configs));
...
#ifdef CONFIG_USB_EHCI_MSM_HSIC
	msm_gpiomux_install(deluxe_u_hsic_configs,
		ARRAY_SIZE(deluxe_u_hsic_configs));
#endif
