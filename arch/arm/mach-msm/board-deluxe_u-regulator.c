...
deluxe_u_gpio_regulator_pdata[] __devinitdata = {
...
struct regulator_init_data deluxe_u_saw_regulator_pdata_8921_s5 =
	
	SAW_VREG_INIT(S5, "8921_s5",	       850000, 1300000);
struct regulator_init_data deluxe_u_saw_regulator_pdata_8921_s6 =
	SAW_VREG_INIT(S6, "8921_s6",	       850000, 1300000);

struct regulator_init_data deluxe_u_saw_regulator_pdata_8821_s0 =
	
	SAW_VREG_INIT(8821_S0, "8821_s0",       850000, 1300000);
struct regulator_init_data deluxe_u_saw_regulator_pdata_8821_s1 =
	SAW_VREG_INIT(8821_S1, "8821_s1",       850000, 1300000);

struct pm8xxx_regulator_platform_data
deluxe_u_pm8921_regulator_pdata[] __devinitdata = {
...
deluxe_u_rpm_regulator_init_data[] __devinitdata = {
...
int deluxe_u_pm8921_regulator_pdata_len __devinitdata =
	ARRAY_SIZE(deluxe_u_pm8921_regulator_pdata);

struct rpm_regulator_platform_data deluxe_u_rpm_regulator_pdata __devinitdata = {
	.init_data		= deluxe_u_rpm_regulator_init_data,
	.num_regulators		= ARRAY_SIZE(deluxe_u_rpm_regulator_init_data),
