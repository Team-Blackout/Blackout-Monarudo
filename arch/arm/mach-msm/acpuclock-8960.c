...
static struct l2_level l2_freq_tbl_8064[] = {
	...
	[19] = { { 1377000, HFPLL, 1, 0, 0x33 }, 1150000, 1150000, 8 },
	[20] = { { 1404000, HFPLL, 1, 0, 0x34 }, 1150000, 1150000, 8 },
};

static struct acpu_level acpu_freq_tbl_8064_slow[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   900000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(7),   950000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x10 }, L2(7),   975000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x12 }, L2(7),   975000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x14 }, L2(7),  1000000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),  1000000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),  1025000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),  1025000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),  1075000 },
	...
	{ 1, {  1539000, HFPLL, 1, 0, 0x39 }, L2(17), 1150000 },
        { 1, {  1674000, HFPLL, 1, 0, 0x40 }, L2(18), 1175000 },
        { 1, {  1755000, HFPLL, 1, 0, 0x41 }, L2(18), 1225000 },
        { 1, {  1782000, HFPLL, 1, 0, 0x42 }, L2(18), 1250000 },
        { 1, {  1809000, HFPLL, 1, 0, 0x43 }, L2(18), 1250000 },
...
static struct acpu_level acpu_freq_tbl_8064_nom[] = {
	...
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(7),   900000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x10 }, L2(7),   925000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x12 }, L2(7),   925000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x14 }, L2(7),   950000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   950000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   975000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),   975000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),  1025000 },
...
static struct acpu_level acpu_freq_tbl_8064_fast[] = {
	...
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(7),   850000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x10 }, L2(7),   875000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x12 }, L2(7),   875000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x14 }, L2(7),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   900000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   925000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),   925000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),   975000 },
...
static struct acpu_level acpu_freq_tbl_8064_faster[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   825000 },
	{ 1, {   384000, PLL_8, 2, 0, 0x00 }, L2(7),   850000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x10 }, L2(7),   875000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x12 }, L2(7),   875000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x14 }, L2(7),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   900000 },
	...
	{ 1, {  1539000, HFPLL, 1, 0, 0x39 }, L2(17), 1150000 },
        ...
        { 1, {  1836000, HFPLL, 1, 0, 0x44 }, L2(18), 1250000 },
        { 1, {  1863000, HFPLL, 1, 0, 0x45 }, L2(18), 1250000 },        
        { 1, {  1890000, HFPLL, 1, 0, 0x46 }, L2(19), 1250000 },
...
static struct acpu_level *acpu_freq_tbl_8064[NUM_PVS] __initdata = {
	...
	[PVS_FASTER]  = acpu_freq_tbl_8064_faster,
};
