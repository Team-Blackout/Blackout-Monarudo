...
void __init deluxe_u_pm8xxx_gpio_mpp_init(void)
{
	int i, rc;
...
static struct pm8xxx_pwrkey_platform_data deluxe_u_pm8921_pwrkey_pdata = {
	.pull_up		= 1,
	.kpd_trigger_delay_us	= 15625,
	.wakeup			= 1,
};

static struct pm8xxx_misc_platform_data deluxe_u_pm8921_misc_pdata = {
	.priority		= 0,
};
...
static struct pm8xxx_gpio_init green_back_gpios[] = {
        PM8921_GPIO_INIT(GREEN_BACK_LED, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 1, \
...
static struct pm8xxx_gpio_init amber_back_gpios[] = {
        PM8921_GPIO_INIT(AMBER_BACK_LED, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 1, \
                                PM_GPIO_PULL_NO, PM_GPIO_VIN_BB, \
                                PM_GPIO_STRENGTH_HIGH, \
                                PM_GPIO_FUNC_2, 0, 0),
        PM8921_GPIO_INIT(AMBER_BACK_LED, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 1, \
...
{
                if (enable)
                        pm8xxx_gpio_config(green_back_gpios[0].gpio, &green_back_gpios[0].config);
                else
                        pm8xxx_gpio_config(green_back_gpios[1].gpio, &green_back_gpios[1].config);
}

static void amber_back_gpio_config(bool enable)
{
                if (enable)
                        pm8xxx_gpio_config(amber_back_gpios[0].gpio, &amber_back_gpios[0].config);
                else
                        pm8xxx_gpio_config(amber_back_gpios[1].gpio, &amber_back_gpios[1].config);
}
...
static struct pm8xxx_led_configure pm8921_led_info[] = {
	[0] = {
        ...
        [1] = {
                ...
                .gpio_status_switch = green_back_gpio_config,
                .led_sync               = 1,
        },
        [2] = {
                .name           = "amber",
                ...
                .function_flags = LED_PWM_FUNCTION | LED_BLINK_FUNCTION,
                .gpio_status_switch = amber_back_gpio_config,
                .led_sync               = 1,
        },
        [3] = {
                .name           = "green-back",
...
static struct pm8xxx_led_platform_data deluxe_u_pm8921_leds_pdata = {
	.num_leds = ARRAY_SIZE(pm8921_led_info),
	.leds = pm8921_led_info,
};


static struct pm8xxx_adc_amux deluxe_u_pm8921_adc_channels_data[] = {
...
static struct pm8xxx_adc_properties deluxe_u_pm8921_adc_data = {
	.adc_vdd_reference	= 1800, 
	.bitresolution		= 15,
	.bipolar                = 0,
};
static const struct pm8xxx_adc_map_pt deluxe_u_adcmap_btm_table[] = {
	{-200,	1671},
	{-190,	1663},
	{-180,	1654},
	{-170,	1646},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = deluxe_u_adcmap_btm_table,
	.size = ARRAY_SIZE(deluxe_u_adcmap_btm_table),
};

static struct pm8xxx_adc_platform_data deluxe_u_pm8921_adc_pdata = {
	.adc_channel		= deluxe_u_pm8921_adc_channels_data,
	.adc_num_board_channel	= ARRAY_SIZE(deluxe_u_pm8921_adc_channels_data),
	.adc_prop		= &deluxe_u_pm8921_adc_data,
	.adc_mpp_base		= PM8921_MPP_PM_TO_SYS(1),
	.adc_map_btm_table	= &pm8xxx_adcmap_btm_table,
	.pm8xxx_adc_device_register	= deluxe_u_pm8xxx_adc_device_register,
};

static struct pm8xxx_mpp_platform_data
deluxe_u_pm8921_mpp_pdata __devinitdata = {
	.mpp_base	= PM8921_MPP_PM_TO_SYS(1),
};

static struct pm8xxx_gpio_platform_data
deluxe_u_pm8921_gpio_pdata __devinitdata = {
	.gpio_base	= PM8921_GPIO_PM_TO_SYS(1),
};

static struct pm8xxx_irq_platform_data
deluxe_u_pm8921_irq_pdata __devinitdata = {
...
static int deluxe_u_pm8921_therm_mitigation[] = {
	1100,
	700,
	600,
	225,
...
pm8921_chg_pdata __devinitdata = {
	...
	.mbat_in_gpio		= 0, 
	.is_embeded_batt	= 1,
	.thermal_mitigation	= deluxe_u_pm8921_therm_mitigation,
	.thermal_levels		= ARRAY_SIZE(deluxe_u_pm8921_therm_mitigation),
	.cold_thr = PM_SMBC_BATT_TEMP_COLD_THR__HIGH,
	.hot_thr = PM_SMBC_BATT_TEMP_HOT_THR__LOW,
};

static struct pm8xxx_ccadc_platform_data
deluxe_u_pm8xxx_ccadc_pdata = {
	.r_sense		= 10,
...
deluxe_u_pm8921_platform_data __devinitdata = {
	.regulator_pdatas	= deluxe_u_pm8921_regulator_pdata,
	.irq_pdata		= &deluxe_u_pm8921_irq_pdata,
	.gpio_pdata		= &deluxe_u_pm8921_gpio_pdata,
	.mpp_pdata		= &deluxe_u_pm8921_mpp_pdata,
	.rtc_pdata		= &deluxe_u_pm8921_rtc_pdata,
	.pwrkey_pdata	= &deluxe_u_pm8921_pwrkey_pdata,
	.misc_pdata		= &deluxe_u_pm8921_misc_pdata,
	.leds_pdata		= &deluxe_u_pm8921_leds_pdata,
	.adc_pdata		= &deluxe_u_pm8921_adc_pdata,
	.charger_pdata		= &pm8921_chg_pdata,
	.bms_pdata		= &pm8921_bms_pdata,
	.ccadc_pdata		= &deluxe_u_pm8xxx_ccadc_pdata,
};

static struct pm8xxx_irq_platform_data
deluxe_u_pm8821_irq_pdata __devinitdata = {
...
static struct pm8xxx_mpp_platform_data
deluxe_u_pm8821_mpp_pdata __devinitdata = {
	.mpp_base	= PM8821_MPP_PM_TO_SYS(1),
};

static struct pm8821_platform_data
deluxe_u_pm8821_platform_data __devinitdata = {
	.irq_pdata	= &deluxe_u_pm8821_irq_pdata,
	.mpp_pdata	= &deluxe_u_pm8821_mpp_pdata,
};

static struct msm_ssbi_platform_data deluxe_u_ssbi_pm8921_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8921-core",
		.platform_data	= &deluxe_u_pm8921_platform_data,
	},
};

static struct msm_ssbi_platform_data deluxe_u_ssbi_pm8821_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8821-core",
		.platform_data	= &deluxe_u_pm8821_platform_data,
	},
};

void __init deluxe_u_init_pmic(void)
{
	pmic_reset_irq = PM8921_IRQ_BASE + PM8921_RESOUT_IRQ;
	apq8064_device_ssbi_pmic1.dev.platform_data =
						&deluxe_u_ssbi_pm8921_pdata;
	apq8064_device_ssbi_pmic2.dev.platform_data =
				&deluxe_u_ssbi_pm8821_pdata;
	deluxe_u_pm8921_platform_data.num_regulators =
					deluxe_u_pm8921_regulator_pdata_len;
