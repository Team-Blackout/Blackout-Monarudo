...
static void dump_all(int more)
{
	...
	reverse_boost_disabled = the_chip->disable_reverse_boost_check;
	...
	pr_info("V=%d mV, I=%d mA, T=%d C, SoC=%d%%, FCC=%d, id=%d mV,"
			...
			" dcin=%d uV, reverse_boost_disabled:%d, flag=%d%d%d%d\n",
